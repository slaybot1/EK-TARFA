...
TAGSRT = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " **𝐀𝐚𝐩𝐤𝐨 𝐆𝐚𝐧𝐚 𝐆𝐚𝐧𝐞 𝐀𝐚𝐭𝐚 𝐇𝐚𝐢𝐧 𝐓𝐨 𝐒𝐮𝐧𝐚 𝐝𝐨 𝐯𝐜 @CHITCHAt_11..?😸** ",
           " **𝐆𝐡𝐮𝐦𝐧𝐞 𝐂𝐡𝐚𝐥𝐨𝐠𝐞..??🙈** ",
           " **𝐊𝐡𝐮𝐬 𝐑𝐚𝐡𝐚 𝐊𝐚𝐫𝐨 ✌️🤞** ",
           ...
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @ITSZ_SHIVAM ]🥰** ",
           " **𝐘𝐞𝐡 𝐁𝐨𝐭 𝐀𝐩𝐤𝐞 𝐆𝐫𝐨𝐮𝐩 𝐌𝐞 𝐀𝐝𝐝 𝐊𝐫𝐝𝐨🥲 [ @defaulters_robot ]😇** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐉𝐚𝐚𝐧😜** ",
           " **𝐆𝐨𝐨𝐝 𝐍8 𝐉𝐢 𝐁𝐡𝐮𝐭 𝐑𝐚𝐭 𝐇𝐨 𝐠𝐲𝐢🥰** ",
           ]

@app.on_message(filters.command(["tagall", "tagmember", "eftag"], prefixes=["/", "@", "#"]))
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("/tagall 𝐆𝐨𝐨𝐝 𝐌𝐨𝐫𝐧𝐢𝐧𝐠 👈 𝐓𝐲𝐩𝐞 𝐋𝐢𝐤𝐞 𝐓𝐡𝐢𝐬")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
